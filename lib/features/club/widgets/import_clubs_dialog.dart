...
class ImportClubsDialog extends StatefulWidget {
  final VoidCallback? onImportComplete;

  const ImportClubsDialog({super.key, this.onImportComplete});

  @override
  State<ImportClubsDialog> createState() => _ImportClubsDialogState();
}

class _ImportClubsDialogState extends State<ImportClubsDialog> {
  final _csvService = ClubCsvService();
  bool _isLoading = false;
  ClubImportResult? _result;
  ...
  Future<void> _selectAndImportFile() async {
    ...
    final result = await _csvService.importClubsFromFile(File(file.path));
    ...
    return AlertDialog(
      title: Row(
        children: [
          ...
          const Text('Importar Clubes via CSV'),
        ],
      ),
      content: SizedBox(
        width: 500,
        child: Column(
          ...
          children: [
            ...
            if (_result != null) ...[
                    ...
                    children: [
                      Row(
                        children: [
                          ...
                          Text(
                            '${_result!.success} clube(s) importado(s) com sucesso',
              ...
              const Text(
                'Selecione um arquivo CSV com os clubes para importar.',
